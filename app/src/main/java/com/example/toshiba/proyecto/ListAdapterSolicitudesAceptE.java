...
public class ListAdapterSolicitudesAceptE extends ArrayAdapter<SolicitudCita> implements OnTaskCompleted {
     ...
     */
    public ListAdapterSolicitudesAceptE(Context context, ArrayList<SolicitudCita> items) {
        super(context, R.layout.item_cita_aceptada, items);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.item_cita_aceptada, null);


        }

        //Objeto Solicitud de aceptar estudiantes a visualizar segun position
        final SolicitudCita item = getItem(position);
        if (item != null) {

            Button calificar = (Button) view.findViewById(R.id.Iaceptar);
            ...
            if (tutor != null) {
                ...
                materia.setText("Materia: "+item.getTutor().getTut_area()+"");
    ...
    private void guardarCal(){
        ...
        try {
            String URL = Util.URL_SRV + "estudiante/calificacion";
